...
- A log-based message broker like [Kafka](https://github.com/Anshul619/HLD-System-Designs/tree/main//2_MessageBrokersEDA/Readme.md) is well suited for transporting the change events from the source database, since it preserves the ordering of messages (avoiding the reordering issue).
